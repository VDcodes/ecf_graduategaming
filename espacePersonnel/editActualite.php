...
$form = $_SERVER["DOCUMENT_ROOT"]."bdd/ajoutActualite.php";
$titre = "Ajouter";
...
if($id_actu != 0) {
  //En modification
  $form = $_SERVER["DOCUMENT_ROOT"]."bdd/modifActualite.php";
  $titre = "Modifier";  
...
<form action=<?php echo $form ?> id="FormulairePost" method="post" enctype="multipart/form-data"> 
  <div class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-header" style="background-color:#37a28a">
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <div>
              <textarea id="textArea_edit" name="texte" >
                <?php echo $descriptif ?>
              </textarea>
            </div>
          </div>
      ...
      <div class="modal-footer">
          ...
          <button type="button" name="validation" onclick="SubmitForm()" class="btn btn-info"><?php echo $titre ?></button>
      </div>
  </div>
</form>
